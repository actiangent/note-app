...
In this branch, UI built entirely in [Jetpack Compose](https://developer.android.com/jetpack/compose)

### Architecture

* Single-activity architecture, using [Navigation Compose](https://developer.android.com/jetpack/compose/navigation).
